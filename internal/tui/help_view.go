...
func newHelpModel() helpModel {
	...
	b.WriteString("FOCUS & PANES\n")
	b.WriteString("  tab            cycle focus: nav \u2192 preview\n")
	b.WriteString("  shift-tab      cycle focus: preview \u2192 nav\n\n")
	b.WriteString("MOVEMENT (when nav focused)\n")
	...
	b.WriteString("MOVEMENT (when preview focused)\n")
	b.WriteString("  j / down       scroll preview down\n")
	b.WriteString("  k / up         scroll preview up\n")
	b.WriteString("  gg             top of preview\n")
	b.WriteString("  G              bottom of preview\n")
	b.WriteString("  ctrl-d / pgdn  half-page down\n")
	b.WriteString("  ctrl-u / pgup  half-page up\n")
	b.WriteString("  ctrl-f         full page down\n")
	b.WriteString("  ctrl-b         full page up\n\n")
	...
	b.WriteString("  l              next filter (in-flight \u2192 all \u2192 done \u2192 archived)\n")
	b.WriteString("  h              prev filter\n\n")
